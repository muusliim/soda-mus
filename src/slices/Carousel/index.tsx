...
const FLAVORS: {
  ...
  { flavor: "lemonLime", color: "#164405", name: "Лимонно-Лаймовый Кайф" },
  {
    ...
    color: "#690B3D",
    name: "Клубничная Вкусняшка",
  },
  { flavor: "watermelon", color: "#4B7002", name: "Арбузная Свежесть" },
];
...
const Carousel = ({ slice }: CarouselProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <h2 className="relative text-center font-lora text-5xl font-bold">
...
function ArrowButton({ direction = "left", label, onClick }: ArrowButtonProps) {
  return (
    <button
      onClick={onClick}
    ...
    >
      <ArrowIcon className={label === "Вперед" ? "rotate-180" : ""} />
