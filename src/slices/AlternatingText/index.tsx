...
const AlternatingText = ({ slice }: AlternatingTextProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="alternating-text-container relative bg-yellow-300 w-full text-sky-950"
    >
      <div>
        <div className="relative z-[100] grid">
          <View className="alternating-can absolute left-0 top-0 h-screen w-full">
            <Scene />
          </View>
          ...
          {slice.primary.text_group.map((item, index) => (
            ...
            >
              ...
              >
                <h2 className="text-balance text-6xl font-bold font-lora">
