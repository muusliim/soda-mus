      ...
      <div className="grid">
        <div className="grid h-screen place-items-center">
          <div className="grid auto-rows-min place-items-center text-center">
            <h1 className="hero-header text-8xl font-black uppercase leading-[.9] text-orange-500 md:text-[9rem] lg:text-[12rem]">
              <TextSplitter
        ...
        <div className="text-side relative z-[80] grid h-screen items-center gap-4 md:grid-cols-2">
          ...
          />
          <div>
            <h2 className="text-side-heading font-lora text-balance text-6xl font-black uppercase text-sky-950 lg:text-8xl">
